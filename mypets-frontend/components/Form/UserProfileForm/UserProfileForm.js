...
const userProfileSchema = Yup.object().shape({
  ...
  dob: Yup.string()
    ...
    .test(
      "is-greater",
      "Birthday should not be greater than current date",
      function (value) {
        ...
        <Form>
            ...
            <Field name="username">
              {({ field, form }) => (
                ...
                >
                  ...
                  <NameInputGroup
                    field={field}
                    valid={!form.errors.username && form.touched.username}
                  />
            ...
            <Field name="dob">
              {({ field, form }) => (
                <FormControl isInvalid={form.errors.dob && form.touched.dob}>
                  ...
                  <BirthdayInputGroup
                    field={field}
                    valid={!form.errors.dob && form.touched.dob}
          ...
          <Box mb={4}>
            <Field name="phone_num">
              {({ field, form }) => (
                <FormControl
                  isInvalid={form.errors.phone_num && form.touched.phone_num}
                >
                  <FormLabel>Phone number</FormLabel>
                  <TelInputGroup
                    field={field}
                    valid={
                      !form.errors.phone_num &&
                      form.touched.phone_num &&
                      nonEmptyRegex.test(field.value)
                    }
                  />
