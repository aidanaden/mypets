...
const locationHelperText =
  "We're delivering to these selected areas in SG for now";
...
const addressSchema = Yup.object().shape({
  ...
  location: Yup.string().test(
    "location",
    "We currently only deliver to customers living in select areas of SG",
    inLocations
  ),
});
              ...
              <Field name="postal">
                {({ field, form }) => (
                  ...
                  >
                    ...
                    <PostalInputGroup
                      field={field}
                      valid={!form.errors.postal && form.touched.postal}
                    />
