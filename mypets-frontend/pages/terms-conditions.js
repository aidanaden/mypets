    ...
    <>
      ...
      <PageContainer>
        ...
        <ParagraphSection
          ...
          mb={{ base: 3 }}
        />
        <ParagraphSection text="- Company (referred to as either the Company, We, Us or Our in this Agreement) refers to MyPets Singapore." />
        <ParagraphSection
          heading="Eligibility"
        ...
        <ParagraphSection
          ...
          mb={{ base: 3 }}
        />
        <ParagraphSection text="- Any access codes and/or passwords provided should be safeguarded at all times. You are responsible for the security of your access codes and/or passwords, and will henceforth be solely liable for any use or unauthorized use of the Site with your access codes and/or passwords." />
        <ParagraphSection
        ...
        <ParagraphSection
          ...
          mb={{ base: 3 }}
        />
        <ParagraphSection text="- Expired products" mb={{ base: 3 }} />
        <ParagraphSection text="- Order discrepancies" mb={{ base: 3 }} />
        <ParagraphSection text="- Wrong products" />
        <ParagraphSection
        ...
        <ParagraphSection
          ...
          mb={{ base: 3 }}
        />
        <ParagraphSection text="- Apple Pay/Google Pay" mb={{ base: 3 }} />
        <ParagraphSection text="- MasterCard (Stripe)" mb={{ base: 3 }} />
        <ParagraphSection text="- Visa (Stripe)" />
        <ParagraphSection
          heading="For Refunds:"
        ...
        <ParagraphSection
          ...
          mb={{ base: 3 }}
        />
        <ParagraphSection text="Beta Promo Code (BETA10OFF) validity will be till 31/12/2021." />
        <ParagraphSection text="Launch (Promo code)" mb={{ base: 3 }} />
        <ParagraphSection
        ...
        <ParagraphSection
          ...
          mb={{ base: 3 }}
        />
        <ParagraphSection text="Launch Promo Code Expiry: 09/06/22, 11:59PM" />
        <ParagraphSection
          heading="Delivery"
        ...
        <ParagraphSection
          ...
          mb={{ base: 3 }}
        />
        <ParagraphSection text="- Eunos" mb={{ base: 3 }} />
        <ParagraphSection text="- Kembangan" mb={{ base: 3 }} />
        <ParagraphSection text="- Chai-Chee" mb={{ base: 3 }} />
        <ParagraphSection text="- Bedok" mb={{ base: 3 }} />
        <ParagraphSection text="- Simei" mb={{ base: 3 }} />
        <ParagraphSection text="- Tampines" mb={{ base: 3 }} />
        <ParagraphSection text="- Pasir Ris" />
        <ParagraphSection
        ...
        <ParagraphSection
          ...
          mb={{ base: 3 }}
        />
        <ParagraphSection text="- Protect against legal liability" />
        <ParagraphSection
        ...
        <ParagraphSection
          ...
          mb={{ base: 3 }}
        />
        <ParagraphSection text="• Phone/WhatsApp: 9126 4942 (anytime)" />
        <ParagraphSection
