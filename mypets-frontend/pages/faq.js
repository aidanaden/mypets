      ...
      <BaseLayout minH="100vh">
        ...
        <PageContainer>
          ...
          <ParagraphSection
            ...
            mb={{ base: 3 }}
          />
          <ParagraphSection text="Whatsapp/Phone Call: 24-7" mb={{ base: 3 }} />
          <ParagraphSection text="If there is a change in delivery address/location , we will require a 1-day notice to accommodate your request." />
          <ParagraphSection
          ...
          <ParagraphSection
            ...
            mb={{ base: 3 }}
          />
          <ParagraphSection text="- Visa/MasterCard" mb={{ base: 3 }} />
          <ParagraphSection text="- Apple Pay" mb={{ base: 3 }} />
          <ParagraphSection text="- Google Pay" />
          <ParagraphSection
          ...
          <ParagraphSection
            ...
            mb={{ base: 3 }}
          />
          <ParagraphSection text="- Total amount spent" mb={{ base: 3 }} />
          <ParagraphSection
            ...
            mb={{ base: 3 }}
          />
          <ParagraphSection text="For products that have been refunded, our team will liaise with you directly for the arrangement once we receive your refund request." />
          <ParagraphSection
          ...
          />
          <ParagraphSection text="- Total amount spent" mb={{ base: 3 }} />
          <ParagraphSection text="Our team will liaise with you directly for the arrangement once we receive your exchange request. Replacement (For Exchange Items) will be carried out on our next immediate delivery day." />
          <ParagraphSection
          ...
          <ParagraphSection
            ...
            mb={{ base: 3 }}
          />
          <ParagraphSection text="We hope to be able to contribute more later." />
          <ParagraphSection
